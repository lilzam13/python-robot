...
Library    DataDriver    C:/Users/lilia/Desktop/python-robot/Test_Case/files/prueba.xlsx    sheet_name=Hoja2
...
*** Test Cases ***
Llenar fomulario    ${name}    ${middle_name}    ${last_name}    ${employee_id}
...
Final
    ...
    Close Browser
Conectar excel
    [Arguments]    ${name}    ${middle_name}    ${last_name}    ${employee_id}
    F_texto    username    Admin
    F_texto    password    admin123
